...
if __name__ == '__main__':
    ...
    assess_diversity = AssessDiversity(identity_transform, identity_transform, identity_transform, identity_transform)
    assess_diversity.create_diversity_analysis_report(example_ipums_demographic_data_df, \
                                                      10, "age", "sex", None, "race", None, None, output_directory_path)
